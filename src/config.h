...
#define BT_NAME "Inokim"    // The name this controller should advertise for BLE
#define BUZPIN 25          // PIN for Piezo buzzer for acoustic signals (e.g. battery warning). Not implemented yet.
#define VESC_RX_PIN 12     // UART RX, connent to TX on VESC
#define VESC_TX_PIN 13     // UART TX, connent to RX on VESC
#define LIGHT_PIN 2        // PIN for the light switch
...
#define WheelDia 0.243                      //Wheel diameter in meters. 10" tire diameter is about 0.25m
#define GearReduction 1                     //reduction ratio. 1 for direct drive. Otherwise motor pulley diameter / Wheel pulley diameter.
#define BatteryMinVoltage 64              //Minimum Battery Voltage = Cell voltage min * Number of cells
#define BatteryMaxVoltage 82              //Maximum Battery Voltage = Cell voltage max * Number of cells
#define SplashScreenFirstLine "Inokim"       //First line of Splash Screen
